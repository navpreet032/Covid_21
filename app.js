...
function myFunction(){
    $(document).ready(function(){
      ...
      function init(){
        ...
        go(conf_state.confirmed,[conf_state.confirmed,conf_state.recovered,conf_state.active])  
        }//if statement
 ...
 if(cases_no>=580829){
    rang='red'}
 else if(cases_no>= 190829){
    rang='orange'
    }
else if(cases_no>=334965){
      rang='yellow'
    }
  ...
  .setPopup(new mapboxgl.Popup({ offset: 25}) // add popups
    .setHTML('<h3>' +'Cases'+ '</h3><p>' + data[1] + '</p>'))
  .addTo(map);
        break;}
      i++;}
